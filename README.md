...
4. Откроется небольшое окно статуса и браузер с интерфейсом
5. В интерфейсе: вставить ссылку → Анализ → качество → Скачать
6. Кнопка **Проверить обновления** скачает и установит новую версию после публикации релиза

Если окно не появилось — посмотрите `vk-video-downloader.log` рядом с exe.
